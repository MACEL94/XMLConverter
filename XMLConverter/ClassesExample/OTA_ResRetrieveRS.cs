...
namespace BELHXmlTool
{
    ...
    public class RoomTypes
    {
        ...
        public List<RoomType> ListaElementoRoomType { get; set; } = new List<RoomType>();
    }
    ...
    public class Rates
    {
        ...
        public List<Rate> ListaElementoRate { get; set; } = new List<Rate>();
    }
    ...
    public class CancelPolicies
    {
        ...
        public List<CancelPenalty> ListaElementoCancelPenalty { get; set; } = new List<CancelPenalty>();
    }
    ...
    public class ServiceRPHs
    {
        ...
        public List<ServiceRPH> ListaElementoServiceRPH { get; set; } = new List<ServiceRPH>();
    }
    ...
    public class TPA_Extensions
    {
        ...
        public List<string> ListaServiceDescription { get; set; }
        [XmlElement(ElementName = "ServiceDescription2", Namespace = "http://www.opentravel.org/OTA/2003/05")]
        ...
        public Form ElementoForm { get; set; } = new Form();
    ...
    public class ResGuests
    {
        ...
        public List<ResGuest> ListaElementoResGuest { get; set; } = new List<ResGuest>();
    }
    ...
    public class SearchParams
    {
        ...
        [XmlElement(ElementName = "param2", Namespace = "http://www.opentravel.org/OTA/2003/05")]
        public string Param2 { get; set; }
        [XmlElement(ElementName = "param3", Namespace = "http://www.opentravel.org/OTA/2003/05")]
